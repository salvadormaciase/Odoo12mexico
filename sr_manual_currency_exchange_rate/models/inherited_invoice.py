            ...
            if inv.payment_term_id:
                ...
                for i, t in enumerate(totlines):
                    ...
                    iml.append({
                        'type': 'dest',
                        'name': name,
                        'price': total_currency / self.manual_currency_exchange_rate if self.active_manual_currency_rate and self.apply_manual_currency_exchange else t[1] ,
                ...
                iml.append({
                    'type': 'dest',
                    'name': name,
                    'price': total_currency / self.manual_currency_exchange_rate if self.active_manual_currency_rate and self.apply_manual_currency_exchange else total,
                    'account_id': inv.account_id.id,
            ...
            if self.currency_id != company_currency:
                ...
                if not (line.get('currency_id') and line.get('amount_currency')):
                    ...
                    if self.active_manual_currency_rate and self.apply_manual_currency_exchange:
                        line['price'] = line['price'] / self.manual_currency_exchange_rate
                    else:
        ...
        if company and currency:
            if company.currency_id != currency:
                ...
                if self.invoice_id.active_manual_currency_rate and self.invoice_id.apply_manual_currency_exchange:
                    self.price_unit = self.price_unit * self.invoice_id.manual_currency_exchange_rate
                else:
